...
=======================================================
Date:             8/29/2001.
file:             ka-dhollow_tga.zip
author:           KaBal 
email address:    kabal@planetquake.com
URL:              http://www.planetquake.com/kabalarena/

=======================================================


Instructions for using the Darkhollow Skybox
---------------------------------------------------
...
4. Close the file and open Q3Radiant and you should
   find on the texture menu the Darkhollow subdirectory.
   
5. Choose the Darkhollow subdirectory and you should find
   the sky texture ready for use.
   
6. If the editor displays 2 textures use the one
   called darkhollow_skybox. The other one is just so
